...
def main():
    ...
    '''
            ------------------------------------Reading Dataset--------------------------------------
    '''
    #Data for training and test, including five pathogen classes and 'Others' class
    global set_data 
    set_data = ".../Algorithm/Raman-OSDL/Raman-OSDL/data/new_data/train_test"
    #Data for test only ('unknown' class, which has never been seen in the training set)
    global other_data
    other_data = ".../Algorithm/Raman-OSDL/Raman-OSDL/data/new_data/unknown"
    ...
    if not args.evaluate:
      ...
      for k in range(0,10):   
            ...
            save_path = os.path.join(args.checkpoint,"{}_fold".format(str(k)))
